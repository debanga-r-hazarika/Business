...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      setTimeout(() => {
        ...
        // In a real app, you would handle login/signup success here
  ...
  useEffect(() => {
    document.title = isLogin ? 'Login | NexusConsult' : 'Sign Up | NexusConsult';
  }, [isLogin]);
          ...
          <Card>
            <div className="text-center mb-8">
              ...
              <p className="text-dark-500">
                {isLogin 
                  ...
                  : 'Join us to apply for internships and track your applications'}
              </p>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-dark-600">
                ...
                <button
                  type="button"
                  onClick={toggleView}
                  className="ml-1 font-medium text-primary-600 hover:text-primary-500 focus:outline-none"
                >
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <button
                  type="button"
                  className="w-full flex justify-center py-2 px-4 border border-dark-200 rounded-md shadow-sm bg-white text-sm font-medium text-dark-700 hover:bg-dark-50"
                >
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4" />
                    <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853" />
                    <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.93l2.85-2.22.81-1.62z" fill="#FBBC05" />
                ...
                >
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
                    <path fillRule="evenodd" d="M10 1.667c-4.6 0-8.334 3.733-8.334 8.333 0 3.683 2.4 6.817 5.734 7.917.417.075.567-.184.567-.4 0-.2-.008-.866-.008-1.583-2.117.4-2.65-.517-2.817-1-.092-.233-.5-1-.834-1.2-.283-.15-.692-.517-.008-.525.642-.009 1.1.583 1.25.825.733 1.233 1.909.884 2.375.675.075-.534.283-.884.517-1.084-1.809-.2-3.709-.9-3.709-4 0-.884.317-1.6.834-2.167-.083-.2-.367-1.025.083-2.133 0 0 .684-.217 2.25.834a7.82 7.82 0 012.084-.283c.7 0 1.4.1 2.083.283 1.567-1.05 2.25-.834 2.25-.834.45 1.108.167 1.933.084 2.133.516.567.833 1.283.833 2.167 0 3.1-1.9 3.8-3.717 4 .292.25.55.734.55 1.484 0 1.075-.008 1.942-.008 2.208 0 .217.15.475.567.392 3.333-1.1 5.733-4.233 5.733-7.916 0-4.6-3.733-8.334-8.333-8.334z" clipRule="evenodd" />
                  </svg>
                </button>
              </div>
            </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-dark-600 mb-4">
                    Create an account to apply for our internship programs. After registration, you'll be able to:
                  </p>
                  <ul className="space-y-2 mb-4">
                    <li className="flex items-start">
                      <span className="text-primary-500 mr-2">•</span>
                      <span>Submit applications to multiple departments</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-primary-500 mr-2">•</span>
                    ...
                    <li className="flex items-start">
                      <span className="text-primary-500 mr-2">•</span>
                      <span>Receive feedback and complete assigned tasks</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-primary-500 mr-2">•</span>
                      <span>Connect with mentors and team members</span>
                    </li>
                  </ul>
